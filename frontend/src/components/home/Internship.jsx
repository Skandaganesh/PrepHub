      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {internships.map((intern, index) => (
          ...
          >
            ...
            <p className="mb-4"> CTC: {intern.ctc}LPA</p>
            <a
  href={`${import.meta.env.VITE_API_URL}/${intern.id}`}
  target="_blank"
  rel="noopener noreferrer"
  className="w-full inline-block text-center font-semibold text-lg px-5 py-3 rounded-md transition-all duration-300 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-pink-600 hover:to-purple-600 shadow-lg hover:shadow-xl"
>
  🚀 Apply Now
</a>
